  ...
  return (
    <div>
      <div className="Header_wrapper flex items-center justify-between">
        <div className="Header_logo flex items-center justify-between w-64">
        ...
        <div className="Header_profile flex items-center justify-end w-full gap-2.5">
          <div className="profile_wrapper cursor-pointer">
            <Image src={profile} alt="Profile" width={38} height={358} />
          </div>
